        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-16 max-w-screen-lg">
          <div className="max-w-lg" ref={refs[0]}>
            <Link href="#">
              <img
                ...
                src="/assets/pictures/ai_blog.jpg"
                alt="Portfolio"
              />
            </Link>
            <div className="p-4">
              <p className="mb-4 font-light text-gray-700 text-xl">
                Exploring Generative AI: Redefining Human Creativity Lorem ipsum
                dolor sit amet consectetur adipisicing elit. Totam quisquam
                recusandae, non saepe illum
              </p>
              <Link
                href="/../blogs/blog1"
          ...
          <div className="max-w-lg" ref={refs[1]}>
            <Link href="#">
              <img
                className="rounded-t-lg w-full object-cover"
                src="/assets/pictures/vr.jpg"
                alt="Portfolio"
              />
            </Link>
            <div className="p-4">
              <p className="mb-4 font-light text-gray-700 text-xl">
                The Immersive World of Virtual Reality: Transforming Reality and
                Beyond Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Totam quisquam recusandae, non saepe illum
              </p>
              <Link
                href="/../blogs/blog2"
                className="relative text-indigo-700 flex items-center group"
