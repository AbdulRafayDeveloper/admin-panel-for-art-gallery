...
function page({params}) {
	...
	const [Formdata, setFormdata] = useState({
	  ...
	  const validateForm = () => {
		const {  projectName, projectCategory, projectTimeline, projectBudget, file } = Formdata;
	  ...
	  const handleSubmit = async (e) => {
		...
		try {
		  ...
		  const response = await axios.post(`../../../api/projects/${params.id}`, FormdataToSend, {
			headers: {
  ...
  return (
	...
	<div className="flex flex-col h-screen bg-white">
      ...
      <div className="flex flex-1 w-full bg-white">
        ...
        <main className="flex-1 p-3 pt-4 h-screen  overflow-auto bg-white mt-4">

		<div className='mb-8 ml-8'>
			<h1 className='text-gray-700 font-medium text-2xl '>Add Project </h1>
			<p className='font-light text-sm'><Link href={`../${params.id}`}>Projects</Link> / Add Project</p>
		</div>
	
		<form className="px-8  pb-8 mb-4 mx-auto max-w-4xl bg-white" encType='multipart/form-data' onSubmit={handleSubmit} method='post'>
