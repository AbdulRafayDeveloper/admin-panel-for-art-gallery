...
function Approach() {
  return (
    <div>
      <section className="bg-gray-900 min-h-screen flex relative z-40 pb-12">
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 w-full">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <p className="text-base text-white md:text-lg">
              We follow a structured and client-centric approach to deliver
              high-quality services that meet your unique business needs.
            </p>
          </div>
          ...
          <div className="grid max-w-md gap-8 row-gap-10 sm:mx-auto lg:max-w-full lg:grid-cols-3">
            <div className="flex flex-col sm:flex-row">
              ...
              <div>
                ...
                <p className="mb-3 text-sm text-white">
                  ...
                  requirements to deliver tailored solutions that drive results.
                </p>
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <div>
                ...
                <p className="mb-3 text-sm  text-white">
                  Our agile development process ensures flexibility and rapid
                  iteration, allowing us to adapt to changes quickly and deliver
                  robust solutions.
                </p>
                <ul className="mb-4 -ml-1 space-y-2">
                  <li className="flex items-start">
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <div>
                ...
                <p className="mb-3 text-sm text-white">
                  We implement rigorous testing and quality assurance processes
                  to ensure that our solutions are reliable, secure, and
                  performant.
                </p>
                <ul className="mb-4 -ml-1 space-y-2">
                  <li className="flex items-start">
