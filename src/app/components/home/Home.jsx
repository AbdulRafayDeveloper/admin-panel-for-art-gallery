...
const page = () => {
  ...
  const testimonials = [
    {
      quote:
        "FWorking with DevWays was an absolute pleasure. Their team demonstrated professionalism, creativity, and dedication throughout the project. They exceeded our expectations and delivered outstanding results. Highly recommend!",
    ...
    {
      quote:
        "I am truly impressed by the quality of work delivered by DevWays. They understood our requirements perfectly and translated them into a phenomenal product. Their attention to detail and commitment to excellence are commendable.",
    ...
    {
      quote:
        "Choosing DevWays for our project was one of the best decisions we made. Their expertise, responsiveness, and proactive approach made the entire process seamless. We are thrilled with the outcome and look forward to collaborating again in the future.",
      author: "David Brown",
    ...
    <div className="tracking-normal text-indigo-400 bg-cover bg-fixed min-h-screen">
      ...
      >
        <div className="px-8 py-8 lg:py-0 flex flex-col justify-center items-center lg:items-start lg:w-1/2">
          ...
          >
            <motion.p
              className="text-lg mb-4 text-center lg:text-left font-light text-gray-500 sm:text-xl dark:text-gray-400"
              style={{ maxWidth: "40rem" }}
            >
              We are a team of passionate developers dedicated to crafting
              exceptional software solutions tailored to your needs.
            </motion.p>
            <motion.p
              className="text-lg mb-4 text-center lg:text-left font-light text-gray-500 sm:text-xl dark:text-gray-400"
              style={{ maxWidth: "40rem" }}
            >
              Our mission is to innovate, create, and deliver cutting-edge
            ...
            <div className="w-full px-4">
              <div className="text-center mx-auto mb-12 lg:mb-20 max-w-[510px]">
                ...
                <p className="text-base text-white">
                  Explore a range of services designed to provide top-notch
          ...
          <div className="flex flex-wrap -mx-4 relative z-10">
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              ...
              >
                ...
                <p className="text-white">
                  Our web development services provide custom, high-performing
                  websites tailored to your business goals. We focus on user
                  experience, responsive design, and seamless functionality to
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              ...
              >
                ...
                <p className="text-white">
                  We specialize in developing robust mobile applications for iOS
                  and Android platforms. Our apps are designed to provide an
                  exceptional user experience, leveraging the latest
                  technologies to deliver high performance and scalability.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              ...
              >
                ...
                <p className="text-white">
                  ...
                  solutions for your business. We provide cloud migration,
                  management, and optimization services to help you leverage the
                  power of the cloud and improve operational efficiency.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              ...
              >
                ...
                <p className="text-white">
                  Boost your online presence with our expert SEO services. We
                  employ advanced techniques to improve your search engine
                  rankings, increase organic traffic, and enhance your website's
                  visibility, ensuring you reach your target audience
                  effectively.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              ...
              >
                ...
                <p className="text-white">
                  Our AI models making service harnesses the power of artificial
                  intelligence to deliver intelligent solutions tailored to your
                  business needs. From predictive analytics to machine learning
                  models, we help you unlock the potential of AI for your
                  operations.
                </p>
              </div>
            </div>
        ...
        <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
          <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">
            ...
            <span className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
              for you through our collaborative expertise within a strategic
              partner network
            </span>{" "}
          </h2>
      ...
      <section className="bg-white dark:bg-gray-800 about-section min-h-screen flex flex-col items-center justify-center py-12">
        <div className="max-w-screen-xl px-4 mx-auto text-center">
          <h2 className=" mb-8 text-4xl font-extrabold tracking-tight text-gray-900 md:text-3xl dark:text-white">
            Discover Our Impact
          </h2>
          <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
            We translate technology into tangible positive outcomes, fostering
        ...
        <div className="max-w-screen-xl grid grid-cols-1 gap-8 px-4 mt-8 md:grid-cols-2 lg:grid-cols-4 lg:gap-16 xl:gap-24">
          ...
          >
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">
              Change makers diving revolution
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">
              Countries with our presence and Clients
            </p>
          </div>
          <div
      ...
      <section className="bg-white dark:bg-gray-900 h-screen flex items-center justify-center">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
          <figure className="max-w-screen-md mx-auto">
            <svg
              className="h-12 mx-auto mb-3 text-gray-400 dark:text-gray-600 animate-bounce"
              viewBox="0 0 24 27"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <blockquote>
              <p className="text-2xl font-medium text-gray-900 dark:text-white italic">
          ...
          <div className="flex justify-center mt-8">
            <button
              className="mr-4 px-6 py-2 bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-200 rounded-full focus:outline-none transform transition-transform duration-300 hover:scale-110"
              onClick={handlePrev}
            >
              Prev
            </button>
            <button
              className="px-6 py-2 bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-200 rounded-full focus:outline-none transform transition-transform duration-300 hover:scale-110"
              onClick={handleNext}
            >
              Next
            </button>
