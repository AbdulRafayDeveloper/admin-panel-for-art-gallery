	...
	<div>
		<footer className="bg-white dark:bg-gray-700">
			...
			<div className="sm:flex sm:items-center sm:justify-between">
				<span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">DevWays™</a>. All Rights Reserved.
				</span>
