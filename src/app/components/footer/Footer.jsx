	...
	<div>
		<footer className="bg-gray-700">
			<div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
				...
				<div className="mb-6 md:mb-0">
					<form className="max-w-sm mx-auto">
						<h2 className='text-2xl font-semibold pb-4 text-white pl-2'>Subscribe</h2>
						<label for="email-address-icon" className="block mb-2 text-sm font-medium text-white pl-2">Stay updated on how future of technology is shaping.</label>
						<div className="flex items-center">
							<div className="relative flex-grow ml-2">
								...
								<input type="text" id="email-address-icon" className="bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500  block w-full ps-10 p-2.5 border-gray-600 placeholder-gray-400 focus:border-blue-500" placeholder="Enter your email here"/>
							</div>
							<button type='button' className='bg-gray-800 text-white p-2 rounded-md font-light ml-2 hover:bg-none hover:bg-gray-500'>Submit</button>
						</div>
					</form>
				</div>
				<div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
					...
					<div>
						<h2 className="mb-6 text-sm font-semibold  uppercase text-white">Insight</h2>
						<ul className="text-gray-400 font-medium">
							<li className="mb-4">
			...
			<div className="sm:flex sm:items-center sm:justify-between pr-14">
				<span className="text-sm  sm:text-center text-gray-400 pl-2 ">© 2024 <a href="https://flowbite.com/" className="hover:underline">DevWays™</a>. All Rights Reserved.
				</span>
				<div className="flex mt-4 sm:justify-center sm:mt-0">
					<Link href="#" className="text-white bg-gray-500 hover:text-gray-500 hover:bg-white rounded-full border-transparent p-1">
						<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
								<path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
							</svg>
						<span className="sr-only">Facebook page</span>
					</Link>
					<Link href="#" className="text-white bg-gray-500 hover:text-gray-500 hover:bg-white rounded-full border-transparent p-1 ms-5">
						<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
						<path fillRule="evenodd" d="M19.25 0H.75C.336 0 0 .336 0 .75v18.5c0 .414.336.75.75.75h18.5c.414 0 .75-.336.75-.75V.75c0-.414-.336-.75-.75-.75zM6.072 16.919H3.266V7.904h2.806v9.015zM4.669 6.741c-.875 0-1.582-.707-1.582-1.582 0-.874.707-1.581 1.582-1.581.875 0 1.581.707 1.581 1.581 0 .875-.707 1.582-1.581 1.582zM16.744 16.919h-2.803V12.62c0-1.021-.018-2.335-1.422-2.335-1.423 0-1.641 1.111-1.641 2.257v4.377h-2.804V7.904h2.695v1.237h.039c.375-.71 1.293-1.456 2.66-1.456 2.844 0 3.372 1.87 3.372 4.299v5.935z" clipRule="evenodd"/>
						</svg>
