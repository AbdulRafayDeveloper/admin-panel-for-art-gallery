	...
	<div>
		<footer className="bg-gray-700">
			<div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
				...
				<div className="mb-6 md:mb-0">
					<form className="max-w-sm mx-auto">
						<h2 className='text-2xl font-semibold pb-4 text-white'>Subscribe</h2>
						<label for="email-address-icon" className="block mb-2 text-sm font-medium text-white">Stay updated on how future of technology is shaping.</label>
			...
			<div className="sm:flex sm:items-center sm:justify-between">
				<span className="text-sm  sm:text-center text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">DevWays™</a>. All Rights Reserved.
				</span>
