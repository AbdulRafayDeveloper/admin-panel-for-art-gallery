	...
	<div>
		<footer className="bg-white dark:bg-gray-700">
			<div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
				...
				<div className="mb-6 md:mb-0">
					<form className="max-w-sm mx-auto">
						...
						<label for="email-address-icon" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stay updated on how future of technology is shaping.</label>
			...
			<div className="sm:flex sm:items-center sm:justify-between">
				<span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">DevWays™</a>. All Rights Reserved.
				</span>
