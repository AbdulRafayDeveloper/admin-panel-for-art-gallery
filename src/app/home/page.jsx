    ...
    <div className="tracking-normal text-indigo-400 bg-cover bg-fixed min-h-screen">
      ...
      >
        <div className="px-8 py-8 lg:py-0 flex flex-col justify-center items-center lg:items-start lg:w-1/2">
          ...
          >
            <motion.p className="text-lg mb-4 text-center lg:text-left font-light text-gray-500 sm:text-xl dark:text-gray-400" style={{ maxWidth: '40rem' }}>
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faDisplay} className="text-white w-16 h-16" />
                </div>
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faMobileScreenButton} className="text-white w-16 h-16" />
                </div>
                <h4 className="font-semibold text-xl text-white mb-3">
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faCloudArrowUp} className="text-white w-16 h-16" />
                </div>
                <h4 className="font-semibold text-xl text-white mb-3">
                  Cloud Services
                </h4>
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faMagnifyingGlass} className="text-white w-16 h-16" />
                </div>
                <h4 className="font-semibold text-xl text-white mb-3">
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faBrain} className="text-white w-16 h-16" />
                </div>
                <h4 className="font-semibold text-xl text-white mb-3">
                  AI Model Generation
                </h4>
      ...
      <section class="bg-white dark:bg-gray-900 mt-0">
        <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">We reimagine business expansion <br /><span className='font-light text-gray-500 sm:text-xl dark:text-gray-400'>for you through our collaborative expertise within a strategic partner network</span> </h2>
      ...
      <section className="bg-white dark:bg-gray-800 about-section min-h-screen flex flex-col items-center justify-center py-12">
        <div className="max-w-screen-xl px-4 mx-auto text-center">
          <h2 className=" mb-8 text-4xl font-extrabold tracking-tight text-gray-900 md:text-3xl dark:text-white">Discover Our Impact</h2>
