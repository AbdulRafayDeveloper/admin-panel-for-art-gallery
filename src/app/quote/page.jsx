    ...
    <div>
      ...
      <section className="bg-white min-h-screen flex md:flex-row justify-center items-center">
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-center ">
          <div>
            <h1 className="text-white text-5xl font-semibold pl-12 pb-8 m-0">
              Request a Quote
            </h1>
          </div>
          <div>
            <p className="text-white text-3xl font-light  pl-12 pb-8">
              Get a personalized quote tailored just for you
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white min-h-screen flex flex-col p-4 md:p-12">
        <div className="w-full">
          <form
            className="px-8  pb-8 mb-4 mx-auto max-w-4xl"
          ...
          >
            ...
            <h1 className="text-3xl text-gray-900 mb-4 mt-8">
              Project Details
            </h1>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
