...
const page = () => {
  ...
  const handleScroll = () => {
    ...
    if (top >= sectionTop - windowHeight * 0.6) {
      ...
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          counters.forEach((counter) => {
            ...
            let count = 0;
            const increment = Math.ceil(target / 200); // Adjust the division to control speed

            const updateCounter = () => {
              if (count < target) {
                count += increment;
                counter.innerText = count;
                setTimeout(updateCounter, 40); // Adjust the timeout to control speed
              } else {
  ...
  const [currentIndex, setCurrentIndex] = useState(0);
    ...
    const testimonials = [
      {
        quote: "FWorking with DevWays was an absolute pleasure. Their team demonstrated professionalism, creativity, and dedication throughout the project. They exceeded our expectations and delivered outstanding results. Highly recommend!",
      ...
      {
        quote: "I am truly impressed by the quality of work delivered by DevWays. They understood our requirements perfectly and translated them into a phenomenal product. Their attention to detail and commitment to excellence are commendable.",
        author: "Sarah Johnson",
        position: "Marketing Director at XYZ Inc.",
        imageSrc: "https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png"
      },
      {
        quote: "Choosing DevWays for our project was one of the best decisions we made. Their expertise, responsiveness, and proactive approach made the entire process seamless. We are thrilled with the outcome and look forward to collaborating again in the future.",
        author: "David Brown",
        position: "COO at LMN Enterprises",
        imageSrc: "https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png"
      }
    ];
  ...
  return (
    <div className="tracking-normal text-indigo-400 bg-cover bg-fixed min-h-screen">
      <Nav  />
      <CustomSlider />
      ...
      <section
        id="about"
        className="bg-gray-800 text-white mt-10 min-h-screen flex flex-col-reverse lg:flex-row justify-center items-center lg:text-left"
        style={{ marginTop: 'calc(100vh - 90px)' }}
      >
        <div className="px-8 py-8 lg:py-0 flex flex-col justify-center items-center lg:items-start lg:w-1/2">
          <motion.h2
          ...
          <motion.div
            className="flex flex-col justify-center items-center lg:items-start mb-8"
            initial={{ opacity: 0, y: 50 }}
            animate={controls}
            transition={{ duration: 0.8, delay: 0.5, ease: 'easeInOut' }}
          >
            <motion.p className="text-lg mb-4 text-center lg:text-left font-light text-white sm:text-xl " style={{ maxWidth: '40rem' }}>
              We are a team of passionate developers dedicated to crafting exceptional software solutions tailored to your needs.
            </motion.p>
            <motion.p className="text-lg mb-4 text-center lg:text-left font-light text-white sm:text-xl " style={{ maxWidth: '40rem' }}>
              Our mission is to innovate, create, and deliver cutting-edge technology that drives your business forward.
            </motion.p>
            <motion.p className="text-lg mb-4 text-center lg:text-left font-light text-white sm:text-xl " style={{ maxWidth: '40rem' }}>
              Let's embark on a journey together to transform your ideas into reality.
            </motion.p>
          </motion.div>
        </div>
        <motion.div
          className="order-first lg:order-last flex justify-center items-center lg:w-1/2"
          initial={{ opacity: 0, y: 50 }}
          animate={controls}
          transition={{ duration: 0.8, delay: 0.3, ease: 'easeInOut' }}
        >
          <div className="overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition duration-500 transform hover:scale-105 hover:rotate-6">
            <img
      ...
      {/*Services*/}
      <section className="pt-20 lg:pt-[120px] pb-12 lg:pb-[90px] relative overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center bg-fixed "
          style={{
            backgroundImage: `url("/assets/pictures/pexels-cottonbro-6804612.jpg")`,
        ...
        <div className="container relative z-0 ">
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="text-center mx-auto mb-12 lg:mb-20 max-w-[510px]">
                <h1 className="font-semibold text-lg text-white mb-2 block">
                  Our Services
                </h1>
                ...
                <p className="text-base text-white">
                  Explore a range of services designed to provide top-notch solutions for your business needs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap -mx-4 relative z-10">
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              <div
                className="
                              p-10
                              md:px-7
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faDisplay} className="text-black w-16 h-16" />
                </div>
                ...
                <p className="text-black">
                  Our web development services provide custom, high-performing websites tailored to your business goals. We focus on user experience, responsive design, and seamless functionality to ensure your online presence stands out.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faMobileScreenButton} className="text-black w-16 h-16" />
                </div>
                <h4 className="font-semibold text-xl text-black mb-3">
                  Mobile Application Development
                </h4>
                <p className="text-black">
                  We specialize in developing robust mobile applications for iOS and Android platforms. Our apps are designed to provide an exceptional user experience, leveraging the latest technologies to deliver high performance and scalability.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faCloudArrowUp} className="text-black w-16 h-16" />
                </div>
                <h4 className="font-semibold text-xl text-black mb-3">
                  Cloud Services
                </h4>
                <p className="text-black">
                 Our cloud services offer scalable, secure, and cost-effective solutions for your business. We provide cloud migration, management, and optimization services to help you leverage the power of the cloud and improve operational efficiency.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faMagnifyingGlass} className="text-black w-16 h-16" />
                </div>
                <h4 className="font-semibold text-xl text-black mb-3">
                  Search Engine Optimization
                </h4>
                <p className="text-black">
                  Boost your online presence with our expert SEO services. We employ advanced techniques to improve your search engine rankings, increase organic traffic, and enhance your website's visibility, ensuring you reach your target audience effectively.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/2 lg:w-1/3 px-2 md:px-4">
              ...
              >
                <div
                  className="
                                  ...
                                  "
                >
                  <FontAwesomeIcon icon={faBrain} className="text-black w-16 h-16" />
                </div>
                <h4 className="font-semibold text-xl text-black mb-3">
                  AI Model Generation
                </h4>
                <p className="text-black">
                  Our AI models making service harnesses the power of artificial intelligence to deliver intelligent solutions tailored to your business needs. From predictive analytics to machine learning models, we help you unlock the potential of AI for your operations.
                </p>
              </div>
            </div>
          </div>
      ...
      {/*Clients Section*/}
      <section className="bg-gray-900 h-screen mt-0">
      <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
        <h2 className="mb-8 lg:mb-16 text-3xl font-bold tracking-tight leading-tight text-center text-white md:text-4xl">
          We reimagine business expansion <br />
          <span className="font-light sm:text-xl text-gray-400">
            for you through our collaborative expertise within a strategic partner network
          </span>
        </h2>
        <div className="grid grid-cols-2 gap-8  sm:gap-12 md:grid-cols-3 lg:grid-cols-6 text-gray-400">
          <Link href="#" className="flex justify-center items-center">
          <svg class="h-9 text-gray-400 hover:text-white" viewBox="0 0 125 35" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="#" className="flex justify-center items-center">
            <svg class="h-9 text-gray-400 hover:text-white" viewBox="0 0 86 29" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="#" className="flex justify-center items-center">
          <svg class="h-8 text-gray-400 hover:text-white" viewBox="0 0 151 34" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="#" className="flex justify-center items-center">
          <svg class="h-9 text-gray-400 hover:text-white" viewBox="0 0 124 38" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="#" className="flex justify-center items-center">
          <svg class="h-9 text-gray-400 hover:text-white" viewBox="0 0 137 37" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="#" className="flex justify-center items-center">
          <svg class="h-6 text-gray-400 hover:text-white" viewBox="0 0 124 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16  text-white rounded-md">
          <p className="text-sm sm:text-sm md:text-sm lg:text-xl xl:text-2xl leading-relaxed">
      ...
      <section className="bg-gray-800 about-section min-h-screen flex flex-col items-center justify-center py-12">
        <div className="max-w-screen-xl px-4 mx-auto text-center">
          <h2 className=" mb-8 text-4xl font-bold tracking-tight md:text-3xl text-white">Discover Our Impact</h2>
          <p className="font-light sm:text-xl text-gray-400">We translate technology into tangible positive outcomes, fostering exceptional experiences.</p>
        </div>
        <div className="max-w-screen-xl grid grid-cols-1 gap-8 px-4 mt-8 md:grid-cols-2 lg:grid-cols-4 lg:gap-16 xl:gap-24">
          ...
          <div ref={(el) => (countersRef.current[1] = el)} className="flex flex-col items-center justify-center">
            <h3 className="mb-2 text-4xl font-bold text-indigo-400">
          ...
          <div ref={(el) => (countersRef.current[2] = el)} className="flex flex-col items-center justify-center">
            <h3 className="mb-2 text-4xl font-bold text-indigo-400">
          ...
          <div ref={(el) => (countersRef.current[3] = el)} className="flex flex-col items-center justify-center">
            <h3 className="mb-2 text-4xl font-bold text-indigo-400">
      ...
      <section className="bg-gray-900 h-screen flex items-center justify-center">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
          <figure className="max-w-screen-md mx-auto">
            <svg className="h-12 mx-auto mb-3 text-gray-600 animate-bounce" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 5.789 20 8H24V18H14.017ZM0 18V10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 5.789 6 8H9.983L9.983 18L0 18Z" fill="currentColor"/>
            </svg>
            <blockquote>
              <p className="text-2xl font-medium text-white italic">{testimonials[currentIndex].quote}</p>
            </blockquote>
            <figcaption className="flex items-center justify-center mt-6 space-x-3">
              <img className="w-12 h-12 rounded-full border-2 border-gray-600" src={testimonials[currentIndex].imageSrc} alt="profile picture" />
              <div className="flex items-center divide-x-2 divide-gray-700">
                <div className="pr-3 font-medium text-white">{testimonials[currentIndex].author}</div>
                <div className="pl-3 text-sm font-light text-gray-400">{testimonials[currentIndex].position}</div>
              </div>
            </figcaption>
          </figure>
          <div className="flex justify-center mt-8">
            <button className="mr-4 px-6 py-2 bg-gray-800 text-gray-200 rounded-full focus:outline-none transform transition-transform duration-300 hover:scale-110" onClick={handlePrev}>
              Prev
            </button>
            <button className="px-6 py-2 bg-gray-800 text-gray-200 rounded-full focus:outline-none transform transition-transform duration-300 hover:scale-110" onClick={handleNext}>
              Next
            </button>
          </div>
        </div>
      ...
      {/*Footer*/}
      <Footer smoothScrollToAbout={smoothScrollToAbout} />
