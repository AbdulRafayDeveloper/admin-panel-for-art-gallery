    ...
    <div className="tracking-normal text-indigo-400 bg-cover bg-fixed min-h-screen">
      ...
      >
        <div className="px-8 py-8 lg:py-0 flex flex-col justify-center items-center lg:items-start lg:w-1/2">
          ...
          >
            <motion.p className="text-lg mb-4 text-center lg:text-left font-light text-gray-500 sm:text-xl dark:text-gray-100" style={{ maxWidth: '40rem' }}>
      ...
      {/*Clients Section*/}
      <section className="bg-white dark:bg-gray-900 h-screen mt-0">
      <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
        <h2 className="mb-8 lg:mb-16 text-3xl font-bold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">
          ...
          <span className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
        ...
        <div className="p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 text-gray-900 dark:text-white rounded-md">
      ...
      <section className="bg-white dark:bg-gray-800 about-section min-h-screen flex flex-col items-center justify-center py-12">
        <div className="max-w-screen-xl px-4 mx-auto text-center">
          <h2 className=" mb-8 text-4xl font-bold tracking-tight text-gray-900 md:text-3xl dark:text-white">Discover Our Impact</h2>
          <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">We translate technology into tangible positive outcomes, fostering exceptional experiences.</p>
        </div>
        <div className="max-w-screen-xl grid grid-cols-1 gap-8 px-4 mt-8 md:grid-cols-2 lg:grid-cols-4 lg:gap-16 xl:gap-24">
          <div ref={(el) => (countersRef.current[0] = el)} className="flex flex-col items-center justify-center">
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">Years of Continual excellence</p>
          </div>
          <div ref={(el) => (countersRef.current[1] = el)} className="flex flex-col items-center justify-center">
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">Change makers diving revolution</p>
          </div>
          <div ref={(el) => (countersRef.current[2] = el)} className="flex flex-col items-center justify-center">
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">Countries with our presence and Clients</p>
          </div>
          <div ref={(el) => (countersRef.current[3] = el)} className="flex flex-col items-center justify-center">
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">Projects Delivered</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-gray-900 h-screen flex items-center justify-center">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
          <figure className="max-w-screen-md mx-auto">
            <svg className="h-12 mx-auto mb-3 text-gray-400 dark:text-gray-600 animate-bounce" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 5.789 20 8H24V18H14.017ZM0 18V10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 5.789 6 8H9.983L9.983 18L0 18Z" fill="currentColor"/>
            </svg>
            <blockquote>
              <p className="text-2xl font-medium text-gray-900 dark:text-white italic">{testimonials[currentIndex].quote}</p>
            </blockquote>
            <figcaption className="flex items-center justify-center mt-6 space-x-3">
              <img className="w-12 h-12 rounded-full border-2 border-gray-300 dark:border-gray-600" src={testimonials[currentIndex].imageSrc} alt="profile picture" />
          ...
          <div className="flex justify-center mt-8">
            <button className="mr-4 px-6 py-2 bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-200 rounded-full focus:outline-none transform transition-transform duration-300 hover:scale-110" onClick={handlePrev}>
              Prev
            </button>
            <button className="px-6 py-2 bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-200 rounded-full focus:outline-none transform transition-transform duration-300 hover:scale-110" onClick={handleNext}>
              Next
            </button>
          </div>
        </div>
