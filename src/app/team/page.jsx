    ...
    <div>
      <section className="relative bg-gray-100">
        ...
        <div className="relative z-20">
          ...
          <div className="flex flex-col items-start justify-center min-h-screen px-12">
            <h1 className="text-white text-5xl font-semibold pb-8 m-0">
              Our Team
            </h1>
            <p className="text-white text-3xl font-light pb-8">
              Explore our talented team driving innovation
            </p>
            <button
          ...
          <div className="p-4 rounded-lg h-screen overflow-y-auto">
            <div ref={gridRef} className="grid grid-cols-1 gap-4 mb-4">
              {[
                ...
                >
                  <p className="text-xl text-black  font-light p-4">{text}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="bg-gray-800 min-h-screen flex relative z-40 pb-12">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8 text-primary pt-16 text-white">
            Meet Our Team
          </h2>
          ...
          <div className="flex justify-center space-x-4 mt-4">
            <button
              onClick={scrollLeft}
              className=" rounded-full text-white px-4 py-2 hover:bg-none hover:bg-indigo-500 hover:text-none hover:text-white focus:outline-none opacity-50"
            >
              <FontAwesomeIcon
                icon={faChevronLeft}
                className="text-white hover:text-none hover:text-white"
              ></FontAwesomeIcon>
            </button>
            <button
              onClick={scrollRight}
              className=" text-indigo-500 px-4 py-2 rounded-full hover:bg-none hover:bg-indigo-500 hover:text-none hover:text-white focus:outline-none opacity-50"
            >
              <FontAwesomeIcon
                icon={faChevronRight}
                className="text-white hover:text-none hover:text-white"
