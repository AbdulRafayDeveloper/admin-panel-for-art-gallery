...
const MapContainer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      SweetAlert(
        "Error",
        error.response?.data?.message || "Form not submitted",
        "error"
      );
    } finally {
  ...
  const address = "Dzone Technologies,C3XX+85C, Ashrafabad, Faisalabad";
      ...
      <section className="bg-white min-h-screen flex flex-col md:flex-row justify-center items-center">
        <div className="md:w-1/2 p-8 md:pl-16">
          <form
            ...
            method="post"
          >
            <h1 className="text-3xl text-gray-900 :text-white mb-4">
            ...
            <div className="mb-4">
              <input
                ...
                name="name"
                className={`bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-2.5 bg-transparent border placeholder-gray-400  focus:border-blue-500 border-gray-600`}
            ...
            <div className="mb-4">
              <PhoneInput
                ...
                className={`bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 block w-full p-[2px] bg-transparent placeholder-gray-400  focus:border-blue-500 border border-gray-600 custom-phone-input`}
            ...
            <div className="mb-4">
              <p className="font-light text-gray-700 text-sm flex justify-end">
                {count}/250
              </p>
              <textarea
                id="message"
            ...
            <div className="text-right">
              <button
                ...
                name="button"
                className={`text-white font-medium rounded-lg text-sm px-5 py-2.5 transition-colors duration-300 ${
                  isSubmitting
                    ? "bg-gray-400 cursor-not-allowed"
                    : "bg-indigo-500 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-blue-300 :bg-indigo-600 :hover:bg-blue-700 :focus:ring-blue-800"
                }`}
              >
        ...
        <div className="md:w-1/2 p-8 md:pr-16 lg:ml-32">
          <div className="mb-8">
            ...
            />
            <h2 className="text-xl font-medium text-gray-900 :text-white mb-4">
              Reach Out to Us
            </h2>
            <p className="text-base text-gray-800 :text-gray-300">
              ABC, Faisalabad,
              <br />
            </p>
            <p className="text-base text-gray-800 :text-gray-300">
