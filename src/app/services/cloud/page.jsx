...
function page() {
  return (
	<div>
		<Service videoSrc={'/assets/videos/cloud.mp4'} title={'Cloud Services Solutions'} subtitle={'Empower with scalable, secure, and reliable cloud solutions'}/>
		<Approach/>
		...
		<div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
			...
			<div className="flex h-[180px] flex-col justify-between rounded-md p-6">
				...
				<p className="text-sm text-white">AWS Cloud services integration</p>
				</div>
			</div>
			</div>
		...
		<List servicesList={['Cloud Consulting Services',
