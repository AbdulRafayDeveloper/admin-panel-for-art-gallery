 ...
 // The animation for aside text
  ...
  return (
    <div>
		...
		<Service videoSrc={'/assets/videos/web.mp4'} title={'Web Development Services'} subtitle={'Tailored Solutions to Boost Your Digital Presence'} />
		...
		<section id="features" className="container mx-auto px-4 space-y-6 bg-slate-800 py-8 md:py-12 lg:py-20">
			...
			<p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
				We specialize in technologies such as React.js, Next.js, Node.js, MongoDB, MySQL, and more. This enables us to create dynamic, scalable, and high-performance web applications tailored to meet your business needs.
			</p>
			...
			<div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
				...
				<div
					className="relative overflow-hidden rounded-lg bg-gray-700 select-none hover:shadow hover:shadow-teal-200 p-2">
				...
				<div className="flex h-[180px] flex-col justify-between rounded-md p-6">
					...
					<img
						src="/assets/pictures/mongodb-icon.svg"
						alt="MongoDB Icon"
					...
					<p className="text-sm text-white">Famous No SQL database used by Industry Experts</p>
					</div>
				</div>
				</div>
				...
				<div className="flex h-[180px] flex-col justify-between rounded-md p-6">
					<div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
					<img
						src="/assets/pictures/nodejs-icon.svg"
						alt="MongoDB Icon"
						className="h-12 w-12 text-indigo-400 grayscale"
					...
					<div className="space-y-2">
					<h3 className="font-bold text-white">NodeJS</h3>
					<p className="text-sm text-white">Server side Scripting Language</p>
					</div>
				</div>
				</div>
				...
				<div className="flex h-[180px] flex-col justify-between rounded-md p-6">
					<div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
					<img
						src="/assets/pictures/mysql-official.svg"
						alt="MongoDB Icon"
						className="h-12 w-12 text-indigo-400 grayscale"
						style={{ filter: 'grayscale(80%)' }} // Applying grayscale filter
					/>
