...
function page() {
  ...
  return (
    <div>
      <Service
        videoSrc={"/assets/videos/web.mp4"}
        title={"Web Development Services"}
        subtitle={"Tailored Solutions to Boost Your Digital Presence"}
      />
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7 text-white">
            We specialize in technologies such as React.js, Next.js, Node.js,
            MongoDB, MySQL, and more. This enables us to create dynamic,
            scalable, and high-performance web applications tailored to meet
            your business needs.
          </p>
        </div>
          ...
          <div className="relative overflow-hidden rounded-lg bg-gray-700 select-none hover:shadow hover:shadow-teal-200 p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-white">
                  Famous No SQL database used by Industry Experts
                </p>
              </div>
            </div>
          </div>
