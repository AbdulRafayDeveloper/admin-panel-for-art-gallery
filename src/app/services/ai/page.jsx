...
function page() {
  return (
    <div>
      <Service
        videoSrc={"/assets/videos/ai.mp4"}
        title={"Advanced AI Solutions"}
        subtitle={"Cutting-edge artificial intelligence services "}
      />
      <Approach />
      <section
        id="features"
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7 text-white">
            We specialize in famous Libraries like Keras, Tensorflow and
            applications like PowerBI, Tableau and more. This enables us to
            create dynamic, scalable, and high-performance applications tailored
            ...
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-white">
                  GIntegrating the power of Chatgpt
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg bg-gray-700 select-none hover:shadow hover:shadow-teal-200 p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-white">
                  Integrating the power of gemini
                </p>
              </div>
            </div>
          </div>
