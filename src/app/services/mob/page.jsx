...
function page() {
  return (
    <div>
      <Service
        videoSrc={"/assets/videos/mob.mp4"}
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7 text-white">
            We specialize in leveraging industry-leading technologies such as
            Swift, Kotlin, React Native, and Flutter to deliver robust and
            scalable mobile app development solutions
          </p>
        </div>
