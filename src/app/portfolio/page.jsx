    ...
    <div>
        ...
        <div className="relative z-20">
          ...
          <div className="flex flex-col items-start justify-center h-full px-12 pt-36">
            ...
            <p className="text-white text-3xl font-light pb-8">
              Delivering cutting-edge solutions with expertise
            </p>
            <button
          ...
          <div className="max-w-lg" ref={refs[0]}>
            ...
            <div className="p-4">
              <p className="mb-4 font-light text-gray-700 text-xl">
                We recently developed an advanced AI-powered analytics dashboard
                designed to revolutionize how businesses interpret and utilize
                their data.
              </p>
              <Link
      ...
      <section className="bg-gray-100 min-h-screen flex justify-center items-center p-8">
        <div className="flex flex-col justify-center items-center space-y-6">
          ...
          <Link
            href="/../quote/"
            className="text-white p-4 rounded-md bg-gray-600 hover:bg-none hover:bg-gray-950"
          >
            LET'S WORK TOGETHER
          </Link>
        </div>
